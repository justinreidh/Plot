...
import { SortableSceneCard } from '../SceneGrid/SortableSceneCard';

export function Demo({scenes, setScenes}) {
    const ACT_LABELS = ["Act 1", "Act 2A"]
    ...
    return (
        ...
        {scenes.slice(0,2).map((row, rowIndex) => (
