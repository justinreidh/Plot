...
export default function Document() {
    ...
    return (
        <div className='w-full relative'>
            ...
            {showNav && (
                <div className='flex flex-row justify-between items-center h-14 pr-4 pl-10 border-b-1 bg-white border-gray-200 sticky top-0 z-100 min-w-232'>  
                    ...
                    <Link href={'/auth'} className="px-4 py-2 ml-2 cursor-pointer border hover:bg-gray-100 rounded">
                        Get Started
                    </Link>
                </div>
            )}
